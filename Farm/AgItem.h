...
public:
  ...
  // Preconditions:  Passed the m_food (to update)
  ...
  // Preconditions:  Passed m_money and m_food (to update)
  // Postconditions: Implemented in child classes
  ...
  //       This is because virtual functions MUST be a member function (not friend)
  // Preconditions:  None
  // Postconditions: Implemented in child classes
